<%-- 
    Document   : login
    Created on : Oct 10, 2016, 11:45:38 AM
    Author     : nhutlm
--%>
                            ...
                            <div class="login-panel panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <fieldset>
                                        ...
                                        <f:input path="user.userName" placeholder="Username" cssClass="form-control"></f:input>
                                            <!--<input class="form-control" placeholder="E-mail" name="email" autofocus>-->
                                        </div>
                                        <div class="form-group">      
                                        <f:input path="password" placeholder="Password" type="password" cssClass="form-control"></f:input>
